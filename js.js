...
if(todayMonth == 11 || todayMonth == 0 || todayMonth == 1){
    wrapper.style.background = 'url("img/bgWi1.jpg") 50%/cover no-repeat';
}else if(todayMonth == 2 || todayMonth == 3 || todayMonth == 4){
    wrapper.style.background = 'url("img/bgsp.jpg") 50%/cover no-repeat';
}else if(todayMonth == 5 || todayMonth == 6 || todayMonth == 7){
    wrapper.style.background = 'url("img/bgsu1.jpg") 50%/cover no-repeat';
}else{
    wrapper.style.background = 'url("img/bgOt.jpg") 50%/cover no-repeat';
}
